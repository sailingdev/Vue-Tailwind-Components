<template>
    ...
    <div class="h-screen flex bg-gray-50 overflow-hidden" x-init="$watch('sidebarOpen', value => { if (value) { $nextTick(() => $refs.sidebar.focus()) } })" @keydown.window.escape="sidebarOpen = false">
      ...
      <div class="flex-1 min-w-0 flex flex-col overflow-hidden">
        ...
        <div class="lg:hidden">
          <div class="bg-indigo-600 py-2 px-4 flex items-center justify-between sm:px-6 lg:px-8">
            ...
            <div>
              <button type="button" @click.stop="sidebarOpen = true" class="-mr-3 h-12 w-12 inline-flex items-center justify-center bg-indigo-600 rounded-md text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
