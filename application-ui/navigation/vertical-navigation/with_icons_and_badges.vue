<template>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
          ...
          <span class="truncate">
            ...
            <span class="bg-white ml-auto inline-block py-0.5 px-3 text-xs rounded-full" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-white&quot;, Default: &quot;bg-gray-100 group-hover:bg-gray-200&quot;">
              5
            </span>
          </a>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>
          ...
          <span class="truncate">
            ...
            <span class="bg-gray-100 group-hover:bg-gray-200 ml-auto inline-block py-0.5 px-3 text-xs rounded-full" x-state-description="undefined: &quot;bg-white&quot;, undefined: &quot;bg-gray-100 group-hover:bg-gray-200&quot;">
              19
            </span>
          </a>
