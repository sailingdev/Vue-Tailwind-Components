              ...
              <div class="px-2 flex items-center lg:px-0">
                ...
                <div class="hidden lg:block lg:ml-6 lg:space-x-4">
                  <div class="flex">
                      ...
                      <a href="#" class="bg-black bg-opacity-25 rounded-md py-2 px-3 text-sm font-medium text-white" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-black bg-opacity-25&quot;, Default: &quot;hover:bg-light-blue-800&quot;">Dashboard</a>
                  
                      <a href="#" class="hover:bg-light-blue-800 rounded-md py-2 px-3 text-sm font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Jobs</a>
                  
                      <a href="#" class="hover:bg-light-blue-800 rounded-md py-2 px-3 text-sm font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Applicants</a>
                  
                      <a href="#" class="hover:bg-light-blue-800 rounded-md py-2 px-3 text-sm font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Company</a>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
          ...
          <div x-description="Mobile menu, show/hide based on menu state." class="bg-light-blue-900 lg:hidden" id="mobile-menu" v-if="open">
            <div class="pt-2 pb-3 px-2 space-y-1">
                ...
                <a href="#" class="bg-black bg-opacity-25 block rounded-md py-2 px-3 text-base font-medium text-white" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-black bg-opacity-25&quot;, Default: &quot;hover:bg-light-blue-800&quot;">Dashboard</a>
            
                <a href="#" class="hover:bg-light-blue-800 block rounded-md py-2 px-3 text-base font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Jobs</a>
            
                <a href="#" class="hover:bg-light-blue-800 block rounded-md py-2 px-3 text-base font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Applicants</a>
            
                <a href="#" class="hover:bg-light-blue-800 block rounded-md py-2 px-3 text-base font-medium text-white" x-state-description="undefined: &quot;bg-black bg-opacity-25&quot;, undefined: &quot;hover:bg-light-blue-800&quot;">Company</a>
