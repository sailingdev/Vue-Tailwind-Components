            ...
            <div>
              ...
              <p class="relative grid grid-cols-2">
                ...
                <span class="pointer-events-none absolute h-12 w-full flex items-center justify-center" aria-hidden="true">
                  <svg class="h-6 w-6 text-indigo-300" x-description="Heroicon name: outline/plus" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
            ...
            <ul class="rounded overflow-hidden grid gap-px sm:grid-cols-2">
                ...
                <li class="bg-indigo-800 bg-opacity-50 py-4 px-4 flex items-center space-x-3 text-base text-white">
                  <svg class="h-6 w-6 text-indigo-300" x-description="Heroicon name: outline/check" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
